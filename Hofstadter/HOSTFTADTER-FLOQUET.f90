...
MODULE LATTICE
  ...
  INTEGER, PARAMETER :: N_SITES_X = 64
  INTEGER, PARAMETER :: N_SITES_Y = 64
  INTEGER, PARAMETER :: N_PARTICLES = 1
  INTEGER, PARAMETER :: HASH_SLOPE = 517
  INTEGER, PARAMETER :: HASH_SHIFT = 3!51459
  INTEGER, PARAMETER :: PERIODIC = 0 ! 1: yes, 0: no
  DOUBLE PRECISION, PARAMETER :: alpha = 21.0/64.0
END MODULE LATTICE
...
MODULE INTERACTION
  ...
  DOUBLE PRECISION, PARAMETER :: J_Y =  1.0  !A. 0.75!B. 1.5 !C. 1.8,!D. 2.25
...
MODULE TIME_DEPENDENT
  ...
  !PRB90 205105
  DOUBLE PRECISION, PARAMETER :: T   =  (2.0*PI)/1.0
