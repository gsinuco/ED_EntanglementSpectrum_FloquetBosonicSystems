...
INTEGER, PARAMETER :: ENTANGLEMENT_SPECTRUM = 1
END MODULE TASKS
...
MODULE LATTICE
  IMPLICIT NONE
  INTEGER, PARAMETER :: N_SITES   = 9
  INTEGER, PARAMETER :: N_SITES_X = 3	
  INTEGER, PARAMETER :: N_SITES_Y = 3
  INTEGER, PARAMETER :: N_PARTICLES = 4
  INTEGER, PARAMETER :: HASH_SLOPE = 35134515
  INTEGER, PARAMETER :: HASH_SHIFT = 314
  DOUBLE PRECISION, PARAMETER :: alpha = -1.0/3.0
END MODULE LATTICE

MODULE SUBLATTICE
  IMPLICIT NONE
  INTEGER, PARAMETER :: N_SITES_A= 10
...
MODULE STATE_OBJ
 TYPE :: STATE      ! State
   ...
   INTEGER, DIMENSION(2) :: site ! where there are particles
   INTEGER, DIMENSION(2) :: ocupation ! number of particles in site
